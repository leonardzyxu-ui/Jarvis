...
class PlannerTests(unittest.TestCase):
    ...
    def test_localos_music_play_maps_waving_through_window_alias_to_available_file(self):
        ...
        self.assertIn("closest LocalOS match", result["reply"])
        self.assertEqual(pending["status"], "available")
...
class RuntimeSurfaceTests(unittest.TestCase):
    ...
    def test_swift_menu_bar_has_shut_up_toggle_contract(self):
        ...
        self.assertIn("stopSpeechMuteStatusSync()", model_source)
        self.assertIn("try await client.speechMuteStatus()", model_source)
        self.assertIn("func refreshSpeechMuteStatusNow() async", model_source)
        self.assertIn("shouldSpeakAfterBackendMuteRefresh()", model_source)
        self.assertIn("Task.sleep(nanoseconds: Self.speechMuteStatusPollNanoseconds)", model_source)
        ...
        self.assertIn("handleStatusHelperSpeechMuteChanged", app_source)
        self.assertIn("speechMuteChanged", app_source)
