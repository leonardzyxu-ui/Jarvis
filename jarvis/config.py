...
OLLAMA_AUTOSTART = env_bool("JARVIS_OLLAMA_AUTOSTART", True)
OLLAMA_STARTUP_TIMEOUT_SECONDS = env_int("JARVIS_OLLAMA_STARTUP_TIMEOUT_SECONDS", 6, minimum=1, maximum=20)
EMAIL_SUMMARY_BACKEND = os.environ.get("JARVIS_EMAIL_SUMMARY_BACKEND", "ollama").strip().lower()
EMAIL_SUMMARY_MODEL = os.environ.get("JARVIS_EMAIL_SUMMARY_MODEL", FAST_MODEL_NAME)
...
MIDDLE_MODEL = os.environ.get("JARVIS_MIDDLE_MODEL", "gpt-oss:120b-cloud").strip() or "gpt-oss:120b-cloud"
MIDDLE_MODEL_TIMEOUT_SECONDS = env_int("JARVIS_MIDDLE_MODEL_TIMEOUT_SECONDS", 18, minimum=4, maximum=60)
MIDDLE_MODEL_MAX_TOKENS = env_int("JARVIS_MIDDLE_MODEL_MAX_TOKENS", 420, minimum=80, maximum=1200)
APP_VOICE_DEFAULTS = env_bool("JARVIS_APP_VOICE_DEFAULTS", False)
TTS_AUTOMATIC_ENABLED = env_bool("JARVIS_TTS_AUTOMATIC_ENABLED", APP_VOICE_DEFAULTS)
