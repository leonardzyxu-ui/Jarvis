...
TTS_PROVIDER = os.environ.get("JARVIS_TTS_PROVIDER", "piper" if APP_VOICE_DEFAULTS else "macos").strip().lower() or "macos"
...
TTS_PIPER_LENGTH_SCALE = env_float("JARVIS_TTS_PIPER_LENGTH_SCALE", 0.76, minimum=0.5, maximum=1.4)
