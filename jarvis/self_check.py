...
def run_self_checks() -> dict[str, Any]:
    ...
    add("planner_app_list_executes", planner.preview("what apps can you open", use_model_router=False).tool == "app.list")
    add("planner_app_status_executes", planner.preview("is Safari running", use_model_router=False).tool == "app.status")
    add("planner_app_running_executes", planner.preview("what apps are running", use_model_router=False).tool == "app.running")
    add("planner_app_frontmost_executes", planner.preview("what app am I using", use_model_router=False).tool == "app.frontmost")
    add("planner_app_focus_routes", planner.preview("focus Safari").tool == "app.focus")
    ...
    add("planner_stop_speaking_routes", planner.preview("stop talking").tool == "voice.stop_speaking")
    ...
    add("planner_workflow_app_task_routes", planner.handle("teams assignment plan").tool == "teams.assignment")
