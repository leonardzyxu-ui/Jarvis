...
SHIPPED_ITEMS = [
    ...
    "Jarvis 0.1.475 makes mute state harder to miss: when speech is muted, the app chip says `Speech Muted` instead of the vague `Muted` label.",
    ...
    "Jarvis 0.1.469 keeps speech emergency status visible: morning status checks both the Jarvis app and status helper, reads the speech mute state, and warns if speech is unmuted while no Shut Up menu control is reachable.",
